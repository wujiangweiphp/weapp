...
class Wechat2
{
    ...
    // 小程序事件
    const EVENT_WEAPP_AUDIT_SUCCESS = 'weapp_audit_success'; // 小程序审核通过
    const EVENT_WEAPP_AUDIT_FAIL = 'weapp_audit_fail'; // 小程序代码审核失败
     ...
     */
    public function valid($return = false, $raw='')
    {
        $encryptStr = "";
